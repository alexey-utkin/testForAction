...
ifndef UTBOT_ALL
    export UTBOT_ALL = $(PROJECT_DIR)/utbot-release-2022.7.3/utbot_distr
endif
...
bin : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/src/__main_shared.mk bin
build : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/src/__main_shared.mk build || $(MAKE) -f $(PROJECT_DIR)/tests/src/__main_obj.mk build
run : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/src/__main_shared.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/src/__main_shared.mk run; exit $$?; } || { $(MAKE) -f $(PROJECT_DIR)/tests/src/__main_obj.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/src/__main_obj.mk run; exit $$?; } }
clean : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/src/__main_shared.mk clean
	$(MAKE) -f $(PROJECT_DIR)/tests/src/__main_obj.mk clean
